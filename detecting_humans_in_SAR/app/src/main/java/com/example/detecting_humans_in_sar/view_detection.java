...
public class view_detection extends AppCompatActivity {
    String[]date,image;
    ListView l1;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_detection);
        l1= findViewById(R.id.detlistview);
        SharedPreferences sh=PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
        String url=sh.getString("url","")+"/view_detection";
...
//                                rating=new String[js1.length()];
       ...
       //                             gamecode[i]=u.getString("game_code");
...
//                                }
                                ...
                                l1.setAdapter(new custom_view_detection(getApplicationContext(),date,image));
